                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="member">
                                    <div class="member-img">
                                        ...
                                        <div class="social">
                                            <a href="https://twitter.com/share?text=text goes here&url=<?php echo base_url('main/bacaberita/'.$berita->id_berita); ?>"><i class="bi bi-twitter" ></i></a>
                                            ...
                                            <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo base_url('main/bacaberita/'.$berita->id_berita); ?>&title=<?php echo $berita->judul_berita; ?>"><i class="bi bi-linkedin"></i></a>
                                        </div>
                                    </div>
                                    <div class="member-info">
                                        ...
                                        <p style="font-style:normal;"><?php echo substr(strip_tags($berita->isi_berita),0,60) . "..."; ?></p>                                      
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
