...
<?php echo $breadcrumb; ?>
<main id="main">
<?php echo $counter_alumni; ?>

<?php echo $kegiatan_alumni; ?>

<?php echo $donasi_alumni; ?>

<?php echo $galeri_alumni; ?>
...
$('#lihat_galeri').on('show.bs.modal', function(e){
    var id = $(e.relatedTarget).data('id');
    $.ajax({
        url : '<?php echo base_url('Main/getDataGaleri'); ?>',
        type : 'POST',
        data : {'id_galeri':id},
        success : function(data){
            $('.modal_galeri').html(data);
        }
    });
});
