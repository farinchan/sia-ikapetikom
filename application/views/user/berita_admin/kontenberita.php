    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <ol>
                ...
                <li><a href="<?php echo base_url('main/beritaadmin'); ?>">Berita Admin</a></li>
...
<section class="inner-page">
    <div class="container">
        ...
        <small style="font-size: 13px;"><i class="far fa-user"></i> Administrator &bull; <i class="far fa-calendar-alt"></i> <?php echo $newDate; ?> &bull; <i class="fas fa-bolt"></i> dilihat <?php echo $berita->total_dilihat; ?></small>
        <div class="row">                
            <div class="col-sm-8" >                
                <section id="team" class="team section-bg" style="background-color: white;" >
                    ...
                    <div class="text-center">
                        ...
                        <small><i>Berita ini dibuat oleh Administrator </i></small>
                    </div>
                    <br>
