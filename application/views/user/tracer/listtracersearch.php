    ...
    <div class="container">
        <div class="d-flex justify-content-between align-items-center">
            <ol>
                ...
                <li><?php if(isset($_GET['search'])){ echo $this->input->get('search'); }else{echo $this->uri->segment(3); } ?></li>
            </ol>
...
<section class="inner-page">
    <div class="container">
        <h2 style="margin-top: -30px;" id="title-konten">Cari : <?php if(isset($_GET['search'])){ echo $this->input->get('search'); }else{echo $this->uri->segment(3); } ?></h2>
        <div class="row">                
            <div class="col-sm-8" >                
                            ...
                            <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="200">
                                <div class="member">
                                    <div class="member-img">
                                        ...
                                        <div class="social">
                                            <a href="https://twitter.com/share?text=text goes here&url=<?php echo base_url('main/bacatracer/'.$tracer->id_tracer); ?>"><i class="bi bi-twitter" ></i></a>
                                            ...
                                            <a href="https://www.linkedin.com/shareArticle?mini=true&url=<?php echo base_url('main/bacatracer/'.$tracer->id_tracer); ?>&title=<?php echo $tracer->judul_tracer; ?>"><i class="bi bi-linkedin"></i></a>
                                        </div>
                                    </div>
                                    <div class="member-info">
                                        ...
                                        <p style="font-style:normal;"><?php echo substr(strip_tags($tracer->isi_tracer),0,60) . "..."; ?></p>                                      
                                    </div>
                                </div>
                            </div>
                            <?php endforeach; ?>
