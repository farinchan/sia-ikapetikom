    ...
    <div class="content-header">
        ...
        <div class="row mb-2">
            ...
            <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item active">Perlu Diproses</li>
                    ...
                    <table class="table table-bordered table-striped" id="SuksesDonasi">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?php echo base_url('admin/ModulDonasi/detail/'.$x->id_donasi.'/'.$x->id_transaksi) ?>"><span class="badge bg-success">Lihat</a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
