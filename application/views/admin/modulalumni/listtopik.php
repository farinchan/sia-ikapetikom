...
<section class="content-header">
    ...
    <div class="row mb-2">
        ...
        <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item active">List Topik</li>
...
<section class="content">
    ...
    <div class="row">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">List Topik</h3>
            </div>
            <div class="card-body">
                <table class="table table-bordered table-striped" id="TahunLulus">
                    ...
                    <tbody>
                        <?php $i=1; foreach ($topik as $x): ?>
                        <tr>
                            <td><?php echo $i++; ?></td>
                            <td><?php echo substr($x->judul_topik, 0, 20)."..."; ?></td>
                            <td><?php echo $x->nama_kategoritopik; ?></td>
                            ...
                            <td><a href="<?php echo base_url('admin/ModulAlumni/edittopik/'.$x->nisn.'/'.$x->id_topik) ?>"><span class="badge bg-primary"><i class="fas fa-edit"></i></span></a>  <a href="<?php echo base_url('main/bacatopik/'.$x->id_topik) ?>" target="_BLANK"><span class="badge bg-success"><i class="fas fa-eye"></i></span></a>  <a href="<?php echo base_url('admin/ModulAlumni/hapustopik/'.$x->id_topik.'/'.$x->nisn) ?>" onclick="return confirm('Yakin Mau Menghapus Topik Ini ?')"><span class="badge bg-danger"><i class="fas fa-trash"></i></span></a> </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
