 ...
 * Document creator.
 */
define ('PDF_CREATOR', 'Administrator');

/**
 * Document author.
 */
define ('PDF_AUTHOR', 'Administrator');

/**
 * Header title.
 */
define ('PDF_HEADER_TITLE', 'Laporan Donasi');

/**
 * Header description string.
 */
define ('PDF_HEADER_STRING', "Dicetak Pada  ".date('y-m-d  H:i:s'));
